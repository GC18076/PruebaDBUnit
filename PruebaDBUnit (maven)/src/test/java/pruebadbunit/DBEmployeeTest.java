...
* - Login y password para acceder la BD
        ...
        System.setProperty(PropertiesBasedJdbcDatabaseTester.DBUNIT_PASSWORD, "clave");
    }
...
// Se crea un Objeto de la clase Employee, que será almacenado en la BD con el método a probar
//
        String idEmp = "8";
...
//
            ...
            IDataSet dsInicialization = new FlatXmlDataSet(new File("src/test/java/pruebadbunit/employee-hr-seed-1-registro.xml"));
...
//
            IDataSet dsExpected = new FlatXmlDataSet(new File("src/test/java/pruebadbunit/employee-hr-seed-1-registro.xml"));
// (5) Verificación
